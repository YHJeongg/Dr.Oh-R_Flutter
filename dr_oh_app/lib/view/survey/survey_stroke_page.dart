...
// Desc: 임시<<
class SurveyStrokePage extends StatefulWidget {
  const SurveyStrokePage({super.key});

  @override
  State<SurveyStrokePage> createState() => _SurveyStrokePageState();
}

class _SurveyStrokePageState extends State<SurveyStrokePage> {
          ...
          child: ListTile(
            title: Column(
              children: [
                ...
                // _answerList(),
                StrokeAnswerList().dAnserList[strokeSurveyModel.seq-1]
              ],
            ),
          ),
        ),
